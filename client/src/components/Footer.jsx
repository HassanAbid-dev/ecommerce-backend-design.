        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex gap-3">
              {[Share2, AtSign, Link2, Camera, Video].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-8 h-8 rounded-full bg-[#BDC4CD] flex items-center justify-center text-white hover:bg-blue-500 transition-all"
                >
          ...
          <div className="lg:col-span-2">
            <h4 className="font-bold text-gray-900 mb-4">Partnership</h4>
            <ul className="space-y-3 text-[#8B96A5] text-sm">
              <li>
                <a href="#" className="hover:text-primary transition-colors">
                  About Us
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-2">
              <a
                href="#"
                className="bg-[#1C1C1C] text-white flex items-center gap-2 px-3 py-2 rounded-lg hover:opacity-90 transition-opacity w-[140px]"
              >
