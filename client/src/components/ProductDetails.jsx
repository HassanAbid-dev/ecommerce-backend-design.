    ...
    return (
      <>
        ...
        <div className="container py-12 text-center">
          <p className="text-[#8B96A5]">Loading product...</p>
        </div>
      </>
    );
  }
  ...
  if (!product) {
    return (
      <>
        <Header />
        <div className="container py-12 text-center">
          <p className="text-[#8B96A5]">Product not found</p>
        </div>
      </>
    );
  }
        ...
        <div className="bg-white border border-[#DEE2E7] rounded-lg p-5 lg:p-8 flex flex-col lg:flex-row gap-8 mb-8 shadow-sm">
          ...
          <div className="lg:w-[450px] flex-shrink-0">
            ...
            <div className="flex gap-3 overflow-x-auto no-scrollbar">
              {[product.imageUrl, ...thumbnails].slice(0, 4).map((img, i) => (
                <div
                  key={i}
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mb-4">
              <span className="px-3 py-1 bg-[#E3F0FF] text-primary text-xs font-medium rounded">
                {product.category}
              </span>
            ...
            <div className="bg-[#FFF0DF] p-4 rounded-lg flex flex-wrap gap-8 items-center mb-6">
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#505050]">Single unit</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="flex-1 min-w-[150px] bg-primary hover:bg-primary-dark text-white py-3 rounded-lg font-bold transition-colors">
                Buy Now
              </button>
              <button className="flex-1 min-w-[150px] bg-[#E3F0FF] hover:bg-[#D1E9FF] text-primary py-3 rounded-lg font-bold transition-colors">
                Add to Cart
              </button>
          ...
          <div className="flex-1">
            <div className="bg-white border border-[#DEE2E7] rounded-lg overflow-hidden mb-8">
              <div className="flex border-b border-[#DEE2E7] bg-white overflow-x-auto no-scrollbar">
                {["Description", "Reviews", "Shipping", "About company"].map(
                  (tab, i) => (
                    <button
                      key={tab}
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex items-center gap-3 text-[#505050] text-sm"
                    >
            ...
            <div className="bg-white border border-[#DEE2E7] rounded-lg p-5">
              ...
              <div className="space-y-4">
                {[thumb1, thumb2, thumb3, thumb4].map((img, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 group cursor-pointer p-2 hover:bg-[#F7FAFC] rounded-lg transition-colors"
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="text-[#1C1C1C] text-sm font-normal group-hover:text-primary transition-colors line-clamp-1 font-medium">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              <div key={i} className="flex flex-col gap-3 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[#505050] text-sm line-clamp-2 group-hover:text-primary transition-colors cursor-pointer">
                    {item.tag}
                  </span>
                  <span className="text-[#8B96A5] text-sm mt-1">
                    {item.price}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-primary to-[#005ADE] rounded-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6 mb-8 text-white relative overflow-hidden">
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="opacity-80 text-sm">
              Have you ever finally just for dummy info.
            </p>
          </div>
